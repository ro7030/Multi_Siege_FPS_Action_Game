...
namespace ProjectM.Player
{
    ...
    {
        // 지금 상호작용 가능한가 (수확물이 있는가, 다운 상태인가 등).
        bool CanInteract(GameObject interactor);

        // 프롬프트에 표시할 메시지 (예: "수확", "Player 1 부활", "문 설치").
        string PromptText { get; }

        // 프롬프트 옆 아이콘 (선택, null 가능).
        Sprite PromptIcon { get; }

        // 홀드형 여부.
        bool IsHold { get; }

        // 홀드 진행도 0~1 (진행바용). 단발형은 0.
